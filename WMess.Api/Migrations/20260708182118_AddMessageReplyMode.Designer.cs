...
namespace WMess.Api.Migrations
{
    ...
    [Migration("20260708182118_AddMessageReplyMode")]
    partial class AddMessageReplyMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMess.Api.Models.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WMess.Api.Models.DocumentFolder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WMess.Api.Models.DocumentPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WMess.Api.Models.Document", b =>
                {
                    ...
                    b.HasOne("WMess.Api.Models.DocumentFolder", "Folder")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("WMess.Api.Models.DocumentFolder", b =>
                {
                    b.HasOne("WMess.Api.Models.DocumentFolder", "ParentFolder")
                        .WithMany("SubFolders")
            ...
            modelBuilder.Entity("WMess.Api.Models.DocumentPermission", b =>
                {
                    b.HasOne("WMess.Api.Models.Document", "Document")
            ...
            modelBuilder.Entity("WMess.Api.Models.PinnedMessage", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "PinnedByUser")
                        .WithMany()
